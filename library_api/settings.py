...
# BASE_DIR definition for file path resolution
...
SECRET_KEY = "django-insecure--jrr&o@20kxf*w(n8ix2dylqm$r5n@4yhmx5%lv%qhb+5+pill"
...
#         'USER': os.getenv('POSTGRES_USER', 'skillyboy'),
